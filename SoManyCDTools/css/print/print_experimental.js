...
var Reveal = (function(){
    ...
    function setupPDF() {
        ...
        //the margin of the previous slide. It will be added to the space the current slide needs at the top.
        var prevBottom = 0;
        ...
        toArray( document.querySelectorAll( SLIDES_SELECTOR ) ).forEach( function( slide ) {
            ...
            if( slide.classList.contains( 'stack' ) === false ) {
                ...
                var left = ( pageWidth - slideWidth ) / 2,
                    paddingTopBottom = ( pageHeight - slideHeight ) / 2,
                    marginTopBottom = 100;

                var contentHeight = getAbsoluteHeight( slide );
                var numberOfPages = Math.ceil( contentHeight / pageHeight );

                //TODO after every page there is a blank page...thats ugly! currently cheap fix with margin and padding mix
                // Center slides vertically
                if( numberOfPages === 1 && config.center || slide.classList.contains( 'center' ) ) {
                    paddingTopBottom = Math.max(((pageHeight - contentHeight ) / 2)-marginTopBottom, 0 );

                }

                // Position the slide inside of the page
                slide.style.left = left + 'px';
                slide.style.paddingTop = paddingTopBottom + 'px';
                slide.style.paddingBottom = paddingTopBottom + 'px';
                slide.style.marginTop = marginTopBottom;
                slide.style.marginBottom = marginTopBottom;
                slide.style.width = slideWidth + 'px';
                prevBottom = ( pageHeight - slideHeight ) / 2;

                /* //slide background
                 slide.backgroundImage = 'url(../OC_Brushes.svg)';
                 slide.backgroundRepeat = 'no-repeat';
                 slide.backgroundSize = '30%';
                 slide.backgroundPosition = 'right center';*/

                // TODO Backgrounds need to be multiplied when the slide stretches over multiple pages
                var background = slide.querySelector( '.slide-background' );
                if( background ) {
                    background.style.width = pageWidth + 'px';
                    background.style.height = ( pageHeight * numberOfPages ) + 'px';
                    background.style.top = -paddingTopBottom + 'px';
